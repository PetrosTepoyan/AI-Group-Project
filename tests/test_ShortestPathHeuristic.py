...
class TestShortestPathHeuristic(unittest.TestCase):
    ...
    def test_snake_maze(self):
        ...
        self.assertEqual(ShortestPathHeuristic()(board=self.board), 1 / 20)
